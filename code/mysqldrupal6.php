...
*/
 ...
 $ACCESS_PWD='222'; #script access password, SET IT if you want to protect script from public access
...
ini_set('session.save_handler', 'files');
 ...
 $DB=array(
 'user'=>$parts['user'],#required
 'pwd'=>$parts['pass'], #required
 'db'=> $path[1],#default DB, optional
 'host'=>$parts['host'],#optional
 'port'=>$parts['port'],#optional
