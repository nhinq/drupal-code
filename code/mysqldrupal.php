...
*/
 ...
 #script access password, SET IT if you want to protect script from public access
...
if (!in_array(array('username', 'password'),$databases)) {
//  die('Database type not support.');
}
